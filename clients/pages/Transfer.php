...
<div class="dashboard-wrapper">
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="nav-menu">
            ...
            <a href="Transfer.php" class="nav-link active"><i class="fa-solid fa-money-bill-transfer"></i> Transfer money</a>
        ...
        <div class="transfer-container">
            <?php if ($step == 1): ?>
                <div class="header-actions" style="margin-bottom: 32px;">
                    <div class="header-welcome">
                        <div class="date-text"><?= $current_date ?></div>
                        <h1 style="font-size: 28px; font-weight: 800; color: var(--text-main); margin: 0;">Transfer Money</h1>
                    </div>
                </div>
            ...
            <?php elseif ($step == 2): ?>
                <div class="widget" style="padding: 40px; border-radius: 32px; text-align: center;">
                    <div class="success-icon" style="background: var(--accent-blue)10; color: var(--accent-blue); width: 80px; height: 80px; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 32px; margin: 0 auto 24px;">
                    ...
                    <form method="POST" id="otpForm">
                        <div class="otp-inputs">
                            <?php for($i=1; $i<=6; $i++): ?>
                                <input type="text" name="otp_in<?= $i ?>" maxlength="1" required autofocus="<?= $i==1 ? 'true' : 'false' ?>">
                            <?php endfor; ?>
                        </div>
            ...
            <?php elseif ($step == 3): ?>
                <?php $t = $_SESSION['transfer'] ?? []; $pending = ($t['amount'] > 5000000); ?>
                <div class="widget" style="padding: 40px; border-radius: 32px; text-align: center;">
                    <div class="success-icon" style="background: <?= $pending ? '#f59e0b' : '#10b981' ?>20; color: <?= $pending ? '#f59e0b' : '#10b981' ?>; width: 80px; height: 80px; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 32px; margin: 0 auto 24px;">
                        <i class="fa-solid <?= $pending ? 'fa-clock' : 'fa-check' ?>"></i>
                    </div>
                    <h2 style="font-weight: 800; color: var(--text-main);"><?= $pending ? 'Pending Approval' : 'Transfer Successful!' ?></h2>
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
                        <a href="Transfer.php" class="btn" style="background: var(--bg-body); border: 1px solid var(--border-color); color: var(--text-main); text-decoration: none; text-align: center; padding: 12px; border-radius: 12px; font-weight: 600;">New Transfer</a>
...
<div class="mobile-bottom-nav">
    ...
    <a href="Transfer.php" class="nav-item active"><i class="fa-solid fa-arrow-right-arrow-left"></i><span>Transfer</span></a>
