        ...
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="nav-menu">
                ...
                <a href="Transactions.php" class="nav-link"><i class="fa-solid fa-clock-rotate-left"></i> Transaction
                    history</a>
                <a href="Buycard.php" class="nav-link active"><i class="fa-solid fa-mobile-screen-button"></i> Buy phone
                    card</a>
                ...
                <?php if (!$success_data): ?>
                    <div class="header-actions" style="margin-bottom: 32px;">
                        <div class="header-welcome">
                            <div class="date-text"><?= $current_date ?></div>
                            <h1 style="font-size: 28px; font-weight: 800; color: var(--text-main); margin: 0;">Buy Phone
                                Card</h1>
                        </div>
                    </div>
                    ...
                    <form method="POST" id="buyCardForm">
                        <div class="widget" style="padding: 32px; border-radius: 24px;">
                            <label style="display: block; margin-bottom: 16px; font-weight: 700; font-size: 16px;">1. Select
                                Carrier</label>
                            ...
                            <label style="display: block; margin-bottom: 16px; font-weight: 700; font-size: 16px;">2. Select
                                Denomination</label>
                            ...
                            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 24px; margin-bottom: 24px;">
                                <div>
                                    ...
                                    <select name="quantity" class="form-control"
                                        style="width: 100%; padding: 12px; border-radius: 12px; border: 1px solid var(--border-color); background: var(--bg-surface); color: var(--text-main);">
                                        <?php for ($i = 1; $i <= 5; $i++): ?>
                                ...
                                <div>
                                    <label style="display: block; margin-bottom: 8px; font-weight: 700;">Transaction
                                        Fee</label>
                                    <div
                                        style="padding: 12px; border-radius: 12px; border: 1px solid var(--border-color); background: var(--bg-body); color: #10b981; font-weight: 700;">
                                        0 ₫
                                    </div>
                                </div>
                            </div>
                            ...
                            <input type="text" name="note" placeholder="Message or reminder..."
                                style="width: 100%; padding: 12px; border-radius: 12px; border: 1px solid var(--border-color); background: var(--bg-surface); color: var(--text-main); margin-bottom: 24px;">
                            ...
                            <button type="submit" class="btn"
                                style="width: 100%; margin-top: 32px; background: var(--accent-blue); color: white; padding: 16px; border-radius: 16px; font-size: 18px; font-weight: 700; border: none; cursor: pointer;">
                                Confirm Purchase
                            </button>
                        </div>
                    </form>
                ...
                <?php else: ?>
                    ...
                    <div class="widget" style="padding: 40px; border-radius: 32px; max-width: 600px; margin: 0 auto;">
                        ...
                        <div style="margin-bottom: 32px;">
                            <label
                                style="display: block; margin-bottom: 12px; font-weight: 700; font-size: 14px; color: var(--text-muted); text-transform: uppercase; letter-spacing: 1px;">Card
                                Codes</label>
                            <?php foreach ($success_data['codes'] as $idx => $code): ?>
                                <div class="card-code-display">
                                    <div>
                                        <div style="font-size: 12px; color: var(--text-muted); margin-bottom: 4px;">Card
                                            <?= $idx + 1 ?> (<?= $success_data['carrier'] ?>)</div>
                        ...
                        <div class="summary-card" style="margin-bottom: 32px;">
                            <div class="summary-row">
                                ...
                                <span><?= number_format($success_data['denomination'], 0, ',', '.') ?> ₫ x
                                    <?= $success_data['quantity'] ?></span>
                            </div>
                            <div class="summary-row">
                        ...
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
                            <a href="Buycard.php" class="btn"
                                style="background: var(--bg-body); border: 1px solid var(--border-color); color: var(--text-main); text-decoration: none; text-align: center; padding: 12px; border-radius: 12px; font-weight: 600;">Buy
                                More</a>
