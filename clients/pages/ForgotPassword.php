...
<body>
    ...
    <div class="container" style="max-height: 90%;">
        <button class="btn btn-danger mt-3 opacity-75 d-flex align-items-center justify-content-center" style="text-decoration: none;" onclick="location.href='Login.php'">
