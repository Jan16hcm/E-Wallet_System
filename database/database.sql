...
CREATE TABLE `history` (
  ...
  `phone_card` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'an array of phone card, max 5',
  `status` tinyint NOT NULL DEFAULT '2' COMMENT '0:Cancelled\n1:Approved\n2:Pending',
  PRIMARY KEY (`id`),
  KEY `fk_history_user` (`user_phone`),
...
--
-- Dumping routines for database 'fakebank'
--
...
-- Dump completed on 2026-05-07 15:56:09
